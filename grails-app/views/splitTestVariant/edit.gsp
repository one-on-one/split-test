...
<div class="body">
    ...
    <div class="span9">
        <div class="page-header">
            <h1>Edit Split Test Variant <small>for ${splitTestVariantInstance?.splitTest?.name}</small></h1>
        </div>
        ...
        <g:form method="post" class="form-horizontal">
            ...
            <div class="form-actions">
                <g:actionSubmit class="btn btn-primary" action="update" value="Update"
                                onclick="return confirm('Are you sure you want to modify the split test variant? This may lead to bad data. It is recommended to archive the test and modify the new cloned one.');"/>
